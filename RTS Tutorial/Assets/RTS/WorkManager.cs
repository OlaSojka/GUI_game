...
namespace RTS {
	public static class WorkManager {
		...
		public static ResourceType GetResourceType(string type) {
			ResourceType temp = ResourceType.Unknown;
			switch(type) {
				case "Money": temp = ResourceType.Money; break;
				//case "Power": temp = ResourceType.Power; break;
				//case "Ore": temp = ResourceType.Ore; break;
				//default: temp = ResourceType.Unknown; break;
			}
			return temp;
		}
